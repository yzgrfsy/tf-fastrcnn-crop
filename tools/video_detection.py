...
NETS = {'vgg16': ('vgg16_faster_rcnn_iter_100000.ckpt',),'res101': ('res101_faster_rcnn_iter_100000.ckpt',)}
...
video_path = "/home/hdd300g/modelers/modeler001/my-tf-faster-rcnn-simple/data/test/videos/input/ch04_20180321070948_20180502144011.mp4"
...
def vis_detections(im, class_name, dets, thresh=0.5):
    ...
    if len(inds) == 0:
	print("Did not detect any objects.")
        #return
    #print(im.shape())
    ...
    for i in inds:
        ...
        cv2.putText(im, class_name, (int(bbox[0]), int(bbox[1] - 1)), font, 1.5, (0, 0, 255), 1)
        #'''
        '''
        ax.add_patch(
    ...
    '''
    print("-----------------------------------------")
    print("the number of objects:",bbox_account)
...
def video_detection():
    ...
    videoWriter = cv2.VideoWriter("/home/hdd300g/modelers/modeler001/my-tf-faster-rcnn-simple/data/test/videos/output/testhequn.mp4", fourcc,
                                  fps,sz)  # 1280, 720
