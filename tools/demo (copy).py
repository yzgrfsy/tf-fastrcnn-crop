...
def crop(im, dets, thresh=0.5):
    ...
    while m <= len(inds):
        for i in inds:
            ...
            cv2.imwrite("/home/yuzhg/my-tf-faster-rcnn-simple/data/imagecrop/" + im_name[0:19] + "_" + str(
...
if __name__ == '__main__':
    ...
    for im_name in im_names:
        ...
        cv2.imwrite("/home/yuzhg/my-tf-faster-rcnn-simple/data/detect_result/" + im_name[0:19] + "detect_result" + ".jpg", im)
