...
def crop(im, dets, thresh=0.5):
    ...
    while m <= len(inds):
        for i in inds:
            ...
            #os.mkdir("/home/yuzhg/my-tf-faster-rcnn-simple/data/imagecrop/3")
            cv2.imwrite("/home/yuzhg/my-tf-faster-rcnn-simple/data/imagecrop/"+ dir +'/' + im_name[0:19] + "_" + str(
...
def demo(sess, net, image_name):
    ...
    im_file = os.path.join(cfg.DATA_DIR, 'demo/'+dir, image_name)
    print(im_file)
...
if __name__ == '__main__':
    ...
    dirs = list(os.listdir("/home/yuzhg/my-tf-faster-rcnn-simple/data/demo/"))
    for dir in dirs:
        os.mkdir("/home/yuzhg/my-tf-faster-rcnn-simple/data/imagecrop/" + dir)
        os.mkdir("/home/yuzhg/my-tf-faster-rcnn-simple/data/detect_result/" + dir)
    #print(im_names)
        im_names = np.array(os.listdir("/home/yuzhg/my-tf-faster-rcnn-simple/data/demo/" + dir))
        print(im_names)
        for im_name in im_names:
            ...
            print("=====================")
            cv2.imwrite("/home/yuzhg/my-tf-faster-rcnn-simple/data/detect_result/" +dir+'/'+ im_name[0:19] + "detect_result" + ".jpg", im)
