...
if __name__ == '__main__':
    ...
    im_names = [#"/home/chenxingli/dengtaAI/dataset/testimages/input/443048211133329708.jpg",
                ...
                "/root/chenxingli/my-tf-faster-rcnn-simple/data/test/image/input/test.jpg"
                ]
    for im_name in im_names:
        ...
        cv2.imwrite("/root/chenxingli/my-tf-faster-rcnn-simple/data/test/image/input/test_result.jpg", im)
   # plt.show()
